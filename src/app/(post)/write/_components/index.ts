...
import AddressSearchSection from '@/app/(post)/write/_components/AddressSearchSection';
import CategorySelectSection from '@/app/(post)/write/_components/CategorySelectSection';
